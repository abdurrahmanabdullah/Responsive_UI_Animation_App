...
class Places {
  ...
  String getPlaceDescription() {
    return 'Bangladesh is a state in the south-eastern part of the china. '
        'Bangladesh is previously a part of the United Bangladesh, '
        'which was later partitioned based on languages. '
        'Bangladesh has more than 4,000 years of continuous cultural history. '
        'Bangladesh has some of the most remarkable temple architecture '
        'in the country, and a living tradition of '
        'music, dance, folk arts and fine arts. '
        'Bangladesh is well renowned for its temple towns and heritage sites,'
